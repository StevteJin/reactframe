...
class PatrolRoute1 extends PureComponent{
    constructor(props) {
        super(props);
        this.state={
            isShow:true,
    ...
    changeIsenable(e,index,camera_code,enable){
        ...
        setTimeout(function(){
            var Enable = !enable;
            console.log(Enable);
            var List=PatrolRoute1.this.state.mapData;
            ...
            console.log(List,PatrolRoute1.this.state.mapData);
        },0)
    }
    //修改是否重点
    ...
    //室内室外
    handleIsIndoor(e){
        PatrolRoute1.this.setState(prevState => ({
            indoor: !prevState.indoor
        }));
        if(!PatrolRoute1.this.state.Indoor){
    ...
    //修改自动巡逻
    //修改是否启用
    changeIsAutopatrol(e){
        PatrolRoute1.this.setState(prevState => ({
            autopatrol: !prevState.autopatrol
        }));
    }
...
{/*                                    <li className="PositionFloor poly">
                                        <span><label>自动巡逻：</label><input type="checkbox" checked={autopatrol} onChange={(e) => this.changeIsAutopatrol(e)}/></span>
                                        <li><span>每隔:</span><input style={{'width':'80px'}} type="text" value={RouteName} onChange={(e)=>this.ChangeRouteName(e)}/><span>分钟巡逻一次</span></li>

                                        <div className="autopatrol">
                                            <select name="" id="">
                                                <option value="">请选择</option>
                                                <option value="">每隔1</option>
                                                <option value="">24小时选择</option>
                                            </select>
                                            <select name="" id="">
                                                <option value="">请选择</option>
