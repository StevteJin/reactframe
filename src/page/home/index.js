...
class Index extends Component {
    ...
    KeLiuData(){
        var list={
            "klC": ["1000226$1$0$0","1000228$1$0$0","1000212$1$0$0","1000221$1$0$0","1000240$1$0$0","1000241$1$0$0","1000242$1$0$0","1000243$1$0$0","1000222$1$0$0","1000225$1$0$0","1000227$1$0$0","1000231$1$0$0","1000232$1$0$0","1000235$1$0$0","1000236$1$0$0","1000238$1$0$0","1000239$1$0$0","1000223$1$0$0","1000261$1$0$0","1000271$1$0$0","1000273$1$0$0","1000211$1$0$0","1000224$1$0$0","1000229$1$0$0","1000230$1$0$0","1000237$1$0$0","1000244$1$0$0","1000245$1$0$0","1000246$1$0$0","1000247$1$0$0","1000248$1$0$0","1000249$1$0$0","1000250$1$0$0","1000251$1$0$0","1000252$1$0$0","1000253$1$0$0","1000269$1$0$0","1000268$1$0$0","1000267$1$0$0","1000266$1$0$0","1000265$1$0$0","1000263$1$0$0","1000262$1$0$0","1000260$1$0$0","1000259$1$0$0","1000258$1$0$0","1000257$1$0$0","1000256$1$0$0","1000255$1$0$0","1000254$1$0$0","1000270$1$0$0","1000272$1$0$0"]
        }
        console.log(list);
        for(var i=0;i<list.klC.length;i++){
            axios.post('http://192.16.12.5:8082/DH/EGTTotal', {
                "cameraId": list.klC[i],
    ...
    onLoad() {
        axios.get(global.Url + 'sys/config/isLogin').then((res) => {
            ...
            if (result) {
                ...
                //                debugger
                if (result.is_login === false) { //如果为false表示要登录，然后判断浏览器缓存里面有没有用户名的缓存，没有直接跳转login,有显示内容
                    if (is_user === null) {
    ...
    SearchContent() {
        ...
        if (!searchName) {
            ...
            axios.post(global.Url + 'business/globalSearch', { Search_info: searchName }).then((res) => {
                const result = res.data.data;
                if (result) {
                    console.log(result);
                    this.setState({
        ...
        return (
            <DocumentTitle title='图为视智慧安防三维平台'>
                <Fragment>
                    ...
                    <div className="header"><Header alarmFlag={alarmFlag}></Header></div>
                    <Footer></Footer>
                    <Alarm></Alarm>
                    ...
                    <div className="KeLiu" style={{'display':'none'}}>总客流量：{KeLi}人</div>
                    ...
                    <div className="Search" style={{'display':'none'}}>
                        <button onClick={() => this.SearchContent()}><i></i></button><input type="text" defaultValue={searchName} onChange={(e) => this.changeSearch(e)} placeholder='请输入您要搜索的关键词' />
                        <div className="SearchName">
                            <ul>
                                {
                                    searchList.length > 0 && searchList.map(
                                        (item, index) => {
                                            return (
                                                <li key={index}>
                                                    {item.type_name}
